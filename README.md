...
- In Task 4, Use the ggplot template code provided to create the bar graph. 
Remark: You can also use `esquisser()` or `mplot()` to create a line chart graph instead of the barchart and generate the ggplot for your code chunk.
